...
function simplify_ingredients(array $rawIngredients): array {
    $commonIngredients = [
        "almond flour", "flour", "sugar", "baking powder", "salt", "milk", "bacon", "egg", "butter", "vanilla extract", "celery", "chicken", 
        ...
        "chicken breast", "cheddar", "onion powder", "carrot", "basil", "parsley", "parmesan", "italian seasoning", "marinara sauce", "pasta",
        ...
        "belgian endive", "rutabaga", "broccoli rabe", "kohlrabi", "microgreens", "yam", "boston lettuce", "delicata squash", "maple syrup",
