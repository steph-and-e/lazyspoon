...
function simplify_ingredients(array $rawIngredients): array {
    $commonIngredients = [
        "flour", "sugar", "baking powder", "salt", "milk", "egg", "butter", "vanilla extract", "celery", "chicken", 
        "oil", "pepper", "onion", "garlic", "cheese", "tomato", "bread", "rice", "olive oil", "garlic powder", 
        "white rice", "cinnamon", "ketchup", "soy sauce", "mayonnaise", "vegetable oil", "brown sugar", "oregano", 
        "potato", "honey", "paprika", "baking soda", "spaghetti", "peanut butter", "chili powder", "cumin", "mustard", 
        "chicken breast", "cheddar", "onion powder", "carrot", "basil", "parsley", "parmesan", "italian seasoning", 
        "thyme", "bell pepper", "scallion", "red onion", "avocado", "zucchini", "shallot", "cherry tomato", "cucumber", 
        "corn", "spinach", "sweet potato", "broccoli", "baby greens", "pumpkin", "cauliflower", "asparagus", "cabbage", 
        "arugula", "kale", "leek", "lettuce", "eggplant", "butternut squash", "romaine", "beetroot", "brussels sprout", 
        "fennel", "radish", "sun dried tomato", "red cabbage", "artichoke", "summer squash", "new potato", "mixed greens", 
        "parsnip", "baby carrot", "sweet pepper", "green tomato", "iceberg", "watercress", "mixed vegetable", "horseradish", 
        "mashed potatoes", "chard", "hash browns", "pimiento", "butter lettuce", "napa cabbage", "spaghetti squash", 
        "coleslaw", "celeriac", "turnip", "bok choy", "okra", "acorn squash", "corn cob", "radicchio", "water chestnut", 
        "pearl onion", "cavolo nero", "leaf lettuce", "tenderstem broccoli", "baby bok choy", "jicama", "collard greens", 
        "plantain", "endive", "corn husk", "french-fried onions", "daikon", "baby corn", "peas and carrots", "potato flakes", 
        "belgian endive", "rutabaga", "broccoli rabe", "kohlrabi", "microgreens", "yam", "boston lettuce", "delicata squash", 
        "asian eggplant", "cress", "broccoli slaw", "frisee", "golden beet", "french fries", "banana pepper", "gem lettuce", 
        "alfalfa", "jerusalem artichoke", "lamb's lettuce", "kabocha squash", "red leaf lettuce", "lemon", "lime", "apple", 
        "banana", "orange", "raisins", "mango", "pineapple", "peach", "date", "coconut", "craisins", "pear", "pomegranate", 
        "grape", "watermelon", "rhubarb", "dried apricot", "kiwi", "grapefruit", "plum", "fig", "apricot", "mandarin", 
        "currant", "prunes", "cantaloupe", "heavy cream", "sour cream", "buttermilk", "yogurt", "greek yogurt", "cream", 
        "whipped cream", "ghee", "shortening", "half and half", "sweetened condensed milk", "evaporated milk", "ice cream", 
